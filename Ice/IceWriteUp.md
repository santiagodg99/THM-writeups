...
![MSRDP](/Ice/Imagenes/Microsoft_Remote_Desktop.png)
...
![Puerto_8000](/Ice/Imagenes/Servicio_Puerto_8000.png)

**ANSWER:** Icecast

### (c) ¿Cuál es el nombre de la máquina?
![Hostname](/Ice/Imagenes/Hostname.png)
...
![RHOSTS_1](/Ice/Imagenes/rhosts_is_empty.png)

Deberemos rellenarlo indicando la **dirección IP que nos ha dado THM**.

![RHOSTS_2](/Ice/Imagenes/IP_rhosts.png)
...
![LHOSTS_1](/Ice/Imagenes/lhost_ip.png)

Establecemos la IP para **LHOST** y ejecutamos el exploit.

![LHOSTS_2](/Ice/Imagenes/ip_lhost_y_ejecucion_exploit.png)
...
![icecast_process](/Ice/Imagenes/icecast_process(1).png)

![icecast_process](/Ice/Imagenes/icecast_process(2).png)
...
![windows_build](/Ice/Imagenes/windows_build.png)
...
![architecture](/Ice/Imagenes/architecture.png)

**ANSWER**: x64

### (e) Ejecutar el comando  **`run post/multi/recon/local_exploit_suggester`**

![potential_escalation_exploits_command](/Ice/Imagenes/potencial_escalation_exploits_command.png)

### (f) ¿Cuál es la ruta completa del primer exploit que aparece?

![potential_escalation_exploits_command](/Ice/Imagenes/ruta_primer_exploit.png)
...
![background_session](/Ice/Imagenes/background_session.png)
...
![uso_exploit](/Ice/Imagenes/utilizar_primer_exploit.png)

### (i) Establecer sesión para el exploit
Podemos confirmar que es necesario hacerlo usando `options`.

![sesion_exploit](/Ice/Imagenes/exploit_session(1).png)

Establecemos la sesión 1, que es la que nos salía antes.

![comando_sessions](/Ice/Imagenes/comando_sessions.png)

![sesion_exploit](/Ice/Imagenes/establecer_sesion.png)
...
![LHOST_incorrecto](/Ice/Imagenes/LHOST_incorrecto.png)
...
![set_LHOST](/Ice/Imagenes/set_lhost.png)

### (l) Ejecutamos el exploit
Escribimos **`run`**

![ejecutar_exploit](/Ice/Imagenes/ejecutar_exploit.png)
...
![getprivs](/Ice/Imagenes/ownership_privilege.png)

**ANSWER**: SeTakeOwnershipPrivilege

## Task 5: Looting
### (a) Listar procesos
![ps](/Ice/Imagenes/listar_procesos.png)

### (b) ¿Cuál es el nombre del "printer spool service"?
![printer_spool_service](/Ice/Imagenes/printer_spool_service.png)
...
![spoolsv.exe](/Ice/Imagenes/migrar_a_spoolsv.png)

### (d) ¿Cuál es nuestro usuario ahora mismo?
Usaremos el comando **`getuid`**

![getuid](/Ice/Imagenes/NTAUTHORITY_SYSTEM.png)

**ANSWER:** NT AUTHORITY\SYSTEM


### (e) Ejecutar Kiwi
![kiwi](/Ice/Imagenes/kiwi.png)

### (f) Abrimos el menú de "AYUDA"
![help](/Ice/Imagenes/help.png)
...
![creds_all](/Ice/Imagenes/creds_all.png)

**ANSWER:** creds_all

### (h) Ejecuta este comando y averigua la contraseña de Dark

![creds_all](/Ice/Imagenes/dark_password.png)
...
![hashdump](/Ice/Imagenes/hashdump.png)
...
![screenshare](/Ice/Imagenes/screenshare.png)
...
![record_mic](/Ice/Imagenes/record_mic.png)
...
![timestomp](/Ice/Imagenes/timestomp.png)
...
![golden_ticket_create](/Ice/Imagenes/golden_ticket_create.png)
...
![habilitar_RDP](/Ice/Imagenes/habilitar_RDP.png)
