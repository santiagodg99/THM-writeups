...
![Puerto_8000](/Recon/Servicio_Puerto_8000.png)

**ANSWER:** Icecast

### (c) ¿Cuál es el nombre de la máquina?
![Hostname](/Ice/Recon/Hostname.png)
...
![RHOSTS_1](/Ice/GainAccess/rhosts_is_empty.png)

Deberemos rellenarlo indicando la **dirección IP que nos ha dado THM**.

![RHOSTS_2](/Ice/GainAccess/IP_rhosts.png)
...
![LHOSTS_1](/Ice/GainAccess/lhost_ip.png)

Establecemos la IP para **LHOST** y ejecutamos el exploit.

![LHOSTS_2](/Ice/GainAccess/ip_lhost_y_ejecucion_exploit.png)
...
![icecast_process](/Ice/Escalate/icecast_process(1).png)

![icecast_process](/Ice/Escalate/icecast_process(2).png)
...
![windows_build](/Ice/Escalate/windows_build.png)
...
![architecture](/Ice/Escalate/architecture.png)

**ANSWER**: x64

### (e) Ejecutar el comando  **run post/multi/recon/local_exploit_suggester**

![potential_escalation_exploits_command](/Ice/Escalate/potencial_escalation_exploits_command.png)

### (f) ¿Cuál es la ruta completa del primer exploit que aparece?

![potential_escalation_exploits_command](/Ice/Escalate/ruta_primer_exploit.png)
...
![background_session](/Ice/Escalate/background_session.png)

![comando_sessions](/Ice/Escalate/comando_sessions.png)
...
![uso_exploit](/Ice/Escalate/utilizar_primer_exploit.png)

### (i) Establecer sesión para el exploit
Podemos confirmar que es necesario hacerlo usando options.

![sesion_exploit](/Ice/Escalate/exploit_session(1).png)
...
![LHOST_incorrecto](/Ice/Escalate/LHOST_incorrecto.png)
...
![set_LHOST](/Ice/Escalate/set_lhost.png)

### (l) Ejecutamos el exploit
Escribimos **run**

![ejecutar_exploit](/Ice/Escalate/ejecutar_exploit.png)
...
![getprivs](/Ice/Escalate/ownership_privilege.png)

**ANSWER**: SeTakeOwnershipPrivilege

## Task 5: Looting
### (a) Listar procesos
![ps](/Ice/Looting/listar_procesos.png)

### (b) ¿Cuál es el nombre del "printer spool service"?
![printer_spool_service](/Ice/Looting/printer_spool_service.png)
...
![spoolsv.exe](/Ice/Looting/migrar_a_spoolsv.png)

### (d) ¿Cuál es nuestro usuario ahora mismo?
Usaremos el comando **getuid**

![getuid](/Ice/Looting/NTAUTHORITY_SYSTEM.png)

**ANSWER:** NT AUTHORITY\SYSTEM


### (e) Ejecutar Kiwi
![kiwi](/Ice/Looting/kiwi.png)

### (f) Abrimos el menú de "AYUDA"
![help](/Ice/Looting/help.png)
...
![creds_all](/Ice/Looting/creds_all.png)

**ANSWER:** creds_all

### (h) Ejecuta este comando y averigua la contraseña de Dark

![creds_all](/Ice/Looting/dark_password.png)
...
![hashdump](/Ice/Post-Exploitation/hashdump.png)
...
![screenshare](/Ice/Post-Exploitation/screenshare.png)
...
![record_mic](/Ice/Post-Exploitation/record_mic.png)
...
![timestomp](/Ice/Post-Exploitation/timestomp.png)
...
![golden_ticket_create](/Ice/Post-Exploitation/golden_ticket_create.png)
...
![habilitar_RDP](/Ice/Post-Exploitation/habilitar_RDP.png)
